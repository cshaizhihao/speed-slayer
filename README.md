...
speed --check                # 环境检测
speed --optimize             # 进入 Speed Slayer TCP 施工面板后执行原生优化
SPEED_TCP_MODE=legacy speed --optimize  # 使用旧上游核心函数兼容模式
SPEED_KERNEL_MODE=legacy speed --optimize  # 使用旧上游内核安装器兼容模式
