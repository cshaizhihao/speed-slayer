...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-v2.0.0-22c55e">
...
首次运行 `--all` 会进入安全主页，不会立即修改系统。你可以在控制台中选择完整流程、TCP 调优或 Argo 节点生成。
...
```bash
bash <(curl -fsSL https://github.com/cshaizhihao/speed-slayer/raw/main/install.sh) --force-all
```
